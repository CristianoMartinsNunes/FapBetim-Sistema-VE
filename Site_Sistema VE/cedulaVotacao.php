<?php
	...
	if($g23 != '')
	{
		$consulta1 = "INSERT INTO VOTACAO (CPF, PROJETO, DATAHORA)VALUES"."('$cpf_Eleitor','$g23',now())"; 
		mysql_query($consulta1);
	}

	if($g24 != '')
	{
		$consulta1 = "INSERT INTO VOTACAO (CPF, PROJETO, DATAHORA)VALUES"."('$cpf_Eleitor','$g24',now())"; 
		mysql_query($consulta1);
	}

	if($g25 != '')
	{
		$consulta1 = "INSERT INTO VOTACAO (CPF, PROJETO, DATAHORA)VALUES"."('$cpf_Eleitor','$g25',now())"; 
		mysql_query($consulta1);
	}

	
	header ("Location:fimVotacao.php");
